...
%7.6 Fan Static Pressure at Test Conditions  
  ...
  %@return Pt = fan total pressure (in. wg.)
  
function [Pt] = calcPt(td0, td5, td6, td2, dewpt, Ps7, Ps5, Ps2, pb, deltaP, D2, D6, D5, E, LD)
    %figure 12 equations
    Pv2 = calcPv2(td0, td5, td6, td2, dewpt, Ps5, Ps2, pb, deltaP, D2, D6, D5, E, LD);
    Pv = Pv2;
    %eq. 7.38
    Pt1 = 0;
    %eq. 7.42
